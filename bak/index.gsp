...
<head>
	...
	<script src="http://jquery-ui.googlecode.com/svn/tags/latest/ui/jquery.ui.widget.js"
	        type="text/javascript"></script>
	<script src="http://jquery-ui.googlecode.com/svn/tags/latest/ui/jquery.ui.button.js"
	        type="text/javascript"></script>
...
//	submitHandler: function() { alert("submitted!"); },
			...
			myForm.validate({
				...
				messages: {
					...
					testMatches: {
						...
						matches: function () {
							return 'Invalid value ' + $('#testMatches').val() + '! Please enter letter only, given format';
						}
					}
				}
			});
	...
	<jqvalui:renderValidationScript for="org.grails.jquery.validation.ui.Person" also="homeAddress, workAddress"
	                                not="homeAddress.code, workAddress.number"/>
