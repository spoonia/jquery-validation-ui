		...
		<table>
			...
			<tr>
				...
				<g:sortableColumn property="title"
				                  title="${message(code: 'dummyDomain.title.label', default: 'Title')}"/>

				<g:sortableColumn property="description"
				                  title="${message(code: 'dummyDomain.description.label', default: 'Description')}"/>

				<g:sortableColumn property="nullableField"
				                  title="${message(code: 'dummyDomain.nullableField.label', default: 'Nullable Field')}"/>

				<g:sortableColumn property="blankField"
				                  title="${message(code: 'dummyDomain.blankField.label', default: 'Blank Field')}"/>
			...
			<g:each in="${dummyDomainInstanceList}" status="i" var="dummyDomainInstance">
				<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
					...
					<td><g:link action="show"
					            id="${dummyDomainInstance.id}">${fieldValue(bean: dummyDomainInstance, field: "id")}</g:link></td>
